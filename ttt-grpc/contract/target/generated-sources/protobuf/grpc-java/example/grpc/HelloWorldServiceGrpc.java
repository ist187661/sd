...
public final class HelloWorldServiceGrpc {
  ...
  public static final String SERVICE_NAME = "example.grpc.HelloWorldService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<example.grpc.HelloWorld.HelloRequest,
      example.grpc.HelloWorld.HelloResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = example.grpc.HelloWorld.HelloRequest.class,
      responseType = example.grpc.HelloWorld.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<example.grpc.HelloWorld.HelloRequest,
      example.grpc.HelloWorld.HelloResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<example.grpc.HelloWorld.HelloRequest, example.grpc.HelloWorld.HelloResponse> getGreetingMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getGreetingMethod = HelloWorldServiceGrpc.getGreetingMethod) == null) {
          HelloWorldServiceGrpc.getGreetingMethod = getGreetingMethod = 
              io.grpc.MethodDescriptor.<example.grpc.HelloWorld.HelloRequest, example.grpc.HelloWorld.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "example.grpc.HelloWorldService", "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  example.grpc.HelloWorld.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  example.grpc.HelloWorld.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloWorldServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void greeting(example.grpc.HelloWorld.HelloRequest request,
        io.grpc.stub.StreamObserver<example.grpc.HelloWorld.HelloResponse> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                example.grpc.HelloWorld.HelloResponse>(
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloWorldServiceBlockingStub> {
     ...
     * </pre>
     */
    public example.grpc.HelloWorld.HelloResponse greeting(example.grpc.HelloWorld.HelloRequest request) {
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractStub<HelloWorldServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<example.grpc.HelloWorld.HelloResponse> greeting(
        example.grpc.HelloWorld.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((example.grpc.HelloWorld.HelloRequest) request,
              (io.grpc.stub.StreamObserver<example.grpc.HelloWorld.HelloResponse>) responseObserver);
          break;
        default:
